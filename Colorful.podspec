...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/tangbinqi/Colorful'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'tangbinqi' => 'tangbinqi@baijia.com' }
  s.source           = { :git => 'https://github.com/tangbinqi/Colorful.git', :tag => s.version.to_s }
